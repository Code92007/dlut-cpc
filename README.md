...
2009 赛季另以 `icpc-official-dlut-2009-recovery-20260922-v1` 补录校内页面列出的 7 条亚洲区域赛成绩：4 银、1 铜、2 个荣誉奖（按站内口径记铁牌）。页面发表于 2010-01-20，但五个赛站均由 ICPC Global 的 2009 赛季赛事元数据交叉确认；武汉站 `Bombee` 与已有 RankLand 记录合并，其余队名和名次无可靠榜单时明确留作待考。名单全部进入人工确认队列，核验详情见 [2009 ICPC 补录清单](docs/icpc-2009-recovery-20260922.md)。
