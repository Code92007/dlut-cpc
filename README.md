...
已经由独立官方名单明确到具体比赛和队名的成员可放入 `rosterCorrections`，在历史成绩导入后一次性确认。修正只填补空名单；线上已经确认或后来修改的名单保持不变。2015 CCPC 仅举办南阳站，官方参赛队伍信息可与南阳榜单按队名直接对应，因此已确认 `EX咖喱棒` 为许思航、邹家树、刘庆周，`为了梦想` 为马少楠、熊昆、刘小坤；核验边界见 [2015 CCPC 南阳站名单说明](docs/ccpc-2015-nanyang-rosters-20260923.md)。
